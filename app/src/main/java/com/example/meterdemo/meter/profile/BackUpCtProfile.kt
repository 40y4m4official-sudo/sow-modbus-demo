...
object BackUpCtProfile {
    val profile = MeterProfile(
        ...
        functionCode = 0x03,
        points = listOf(
            MeterPoint("A相電圧", 37101, 2, 10.0, DataType.INT, "V", 1010),
            MeterPoint("B相電圧", 37103, 2, 10.0, DataType.INT, "V", 1010),
            MeterPoint("A相電流", 37107, 2, 100.0, DataType.INT, "A", 500),
            MeterPoint("B相電流", 37109, 2, 100.0, DataType.INT, "A", 400),
            ...
            MeterPoint("B-C線電圧", 37128, 2, 10.0, DataType.INT, "V", 1010),
            MeterPoint("C-A線電圧", 37130, 2, 10.0, DataType.INT, "V", 1010),
            MeterPoint("A相有効電力", 37132, 2, 1000.0, DataType.INT, "kW", 479750),
            MeterPoint("B相有効電力", 37134, 2, 1000.0, DataType.INT, "kW", 383800)
        )
    )
}
