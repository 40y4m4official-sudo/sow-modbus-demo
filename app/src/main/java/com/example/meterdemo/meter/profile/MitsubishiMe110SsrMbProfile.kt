...
object MitsubishiMe110SsrMbProfile {
    val profile = MeterProfile(
        ...
        points = listOf(
            ...
            MeterPoint("A相電流", 768, 1, 1.0, DataType.INT, "A", 4, signalType = SignalType.PHASE_A_CURRENT),
            MeterPoint("B相電流", 769, 1, 1.0, DataType.INT, "A", 5, signalType = SignalType.PHASE_B_CURRENT),
            MeterPoint("C相電流", 770, 1, 1.0, DataType.INT, "A", 6, signalType = SignalType.PHASE_C_CURRENT),
            MeterPoint("有効電力", 794, 1, 1.0, DataType.INT, "kW", 94, signalType = SignalType.ACTIVE_POWER_TOTAL),
            MeterPoint("A相有効電力", 791, 1, 1.0, DataType.INT, "kW", 25, signalType = SignalType.PHASE_A_ACTIVE_POWER),
            MeterPoint("B相有効電力", 792, 1, 1.0, DataType.INT, "kW", 31, signalType = SignalType.PHASE_B_ACTIVE_POWER),
            MeterPoint("C相有効電力", 793, 1, 1.0, DataType.INT, "kW", 38, signalType = SignalType.PHASE_C_ACTIVE_POWER),
            MeterPoint("無効電力", 802, 1, 1.0, DataType.INT, "kVar", 31, signalType = SignalType.REACTIVE_POWER_TOTAL),
            MeterPoint("皮相電力", 806, 1, 1.0, DataType.INT, "kVA", 99, signalType = SignalType.APPARENT_POWER_TOTAL),
