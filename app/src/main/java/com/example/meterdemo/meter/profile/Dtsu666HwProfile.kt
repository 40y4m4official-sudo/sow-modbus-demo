...
object Dtsu666HwProfile {
    val profile = MeterProfile(
        ...
        points = listOf(
            ...
            floatPoint("A相電流", 2102, 1.0, SignalType.PHASE_A_CURRENT, 1.0),
            floatPoint("B相電流", 2104, 1.0, SignalType.PHASE_B_CURRENT, 2.0),
            floatPoint("C相電流", 2106, 1.0, SignalType.PHASE_C_CURRENT, 3.0),
            floatPoint("有効電力", 2264, 1000.0, SignalType.ACTIVE_POWER_TOTAL, 37.62),
            floatPoint("A相有効電力", 2266, 1000.0, SignalType.PHASE_A_ACTIVE_POWER, 6.27),
            floatPoint("B相有効電力", 2268, 1000.0, SignalType.PHASE_B_ACTIVE_POWER, 12.54),
            floatPoint("C相有効電力", 2270, 1000.0, SignalType.PHASE_C_ACTIVE_POWER, 18.81),
            floatPoint("無効電力", 2272, 1000.0, SignalType.REACTIVE_POWER_TOTAL, 12.35),
            floatPoint("皮相電力", 2142, 1000.0, SignalType.APPARENT_POWER_TOTAL, 3.96),
            floatPoint("合計有効電力量", 2158, 1.0, SignalType.TOTAL_ACTIVE_ENERGY, 0.0),
            floatPoint("合計無効電力量", 2206, 1.0, SignalType.TOTAL_REACTIVE_ENERGY, 0.0),
            floatPoint("正方向合計有効電力量", 2166, 1.0, SignalType.FORWARD_ACTIVE_ENERGY_TOTAL, 1234.5),
            floatPoint("正方向合計無効電力量", 2214, 1.0, SignalType.FORWARD_REACTIVE_ENERGY_TOTAL, 0.0),
            floatPoint("負方向合計有効電力量", 2174, 1.0, SignalType.REVERSE_ACTIVE_ENERGY_TOTAL, 1.23),
